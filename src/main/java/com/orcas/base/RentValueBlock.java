...
public class RentValueBlock {
    ...
    static {
        PRICE_BLOCK = ImmutableMap.<String, RentValueBlock>builder()
                ...
                .put("5000-7000", new RentValueBlock("5000-7000", 5000, 7000))
                .put("7000-*", new RentValueBlock("7000-*", 7000, -1))
                .build();
        AREA_BLOCK = ImmutableMap.<String, RentValueBlock>builder()
                ...
                .put("90-*", new RentValueBlock("90-*", 90, -1))
                .build();
    }
